...
ini_set('display_errors', 1); // Temporary for debugging, set to 0 in production
    ...
    <section id="sec-ae5f" class="login-section">
        <div>
            <div>
                ...
                <div>
                    <form action="../php/pending_loginCode.php" method="POST">
                        <div class="u-form-group u-form-name">
                            <label for="email" class="u-label">Email</label><br>
                            <input type="email" placeholder="Enter Email" id="email" name="email" required="">
                        </div>
                        <div class="u-form-email u-form-group">
                            <label for="password" class="u-label">Password</label><br>
                        ...
                        <p><a href="signup.php" class="register-here">Register Here</a></p>
                    </form>
                    <br>
                </div>
            </div>
