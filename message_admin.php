...
<body>
                    ...
                    <div class="contacts-list">
                        ...
                        try {
                            ...
                            foreach ($admins as &$admin) {
                                $stmt = $conn->prepare("
                                    SELECT c.id 
                                    FROM conversations_admin_student c
                                    JOIN conversation_participants cp1 ON c.id = cp1.conversation_id
                                    JOIN conversation_participants cp2 ON c.id = cp2.conversation_id
                                    WHERE cp1.user_id = ? AND cp2.user_id = ?
                                    LIMIT 1
                                ");
                                $stmt->execute([$student_id, $admin['id']]);
                        ...
                        if (count($admins) > 0) {
                            ...
                            echo "<div class='text-center p-4'>No admins found</div>";
                        }
                        ?>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        function loadStudentMessages(adminId) {
            if (!adminId) return;
            ...
            $('#chatStudentName').text(adminName || 'Admin');
            ...
            $('#chatStudentInfo').text(adminCourse);
