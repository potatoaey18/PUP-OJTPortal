...
<body>
                    ...
                    <table class="company-table">
                        ...
                        <tbody>
                            ...
                            foreach ($companies as $company) {
                                echo '<tr>';
                                echo '<td><button class="view-profile-btn" data-supervisor-id="' . htmlspecialchars($company['supervisorID']) . '">View Profile</button></td>';
    ...
    <!-- Optional: Fallback for jQuery if CDN fails -->
