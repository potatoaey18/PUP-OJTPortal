...
if (isset($_POST['submit'])) {
    ...
    error_log("Temporary file path: " . $_FILES["portfolioDocument"]["tmp_name"]);
    error_log("Upload error code: " . $_FILES["portfolioDocument"]["error"]);
    ...
    if ($_FILES["portfolioDocument"]["size"] > 10000000) {
        error_log("File size exceeds limit: " . $_FILES["portfolioDocument"]["size"]);
    ...
    if (move_uploaded_file($_FILES["portfolioDocument"]["tmp_name"], $target_file)) {
        ...
        error_log("File move failed. Error: " . $_FILES["portfolioDocument"]["error"]);
        $_SESSION['status'] = "Upload failed. Error: " . $_FILES["portfolioDocument"]["error"];
        $_SESSION['status-code'] = "error";
    }
...
if ($existing_document) {
    $status_msg = [
        ...
        'pending' => "Your Portfolio has been submitted and Under review."
    ];
                    ...
                    <div class="content">
                        ...
                        <div class="action-buttons">
                            <form id="uploadForm" action="" method="POST" enctype="multipart/form-data">
                                <input type="file" id="fileInput" name="portfolioDocument" accept=".pdf,.doc,.docx" class="hidden">
