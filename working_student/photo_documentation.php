...
$target_dir = $_SERVER['DOCUMENT_ROOT'] . "/PUP/student/uploads/photo_documentation/";
$relative_dir = "/PUP/student/uploads/photo_documentation/";
...
if (isset($_POST['submit'])) {
    ...
    $original_name = basename($_FILES["photo_documentationDocument"]["name"]);
    ...
    error_log("Temporary file path: " . $_FILES["photo_documentationDocument"]["tmp_name"]);
    error_log("Upload error code: " . $_FILES["photo_documentationDocument"]["error"]);

    $finfo = finfo_open(FILEINFO_MIME_TYPE);
    $mime = finfo_file($finfo, $_FILES["photo_documentationDocument"]["tmp_name"]);
    $allowed_mimes = [
        'application/pdf', 
        'application/msword', 
    ...
    if (!in_array($mime, $allowed_mimes)) {
        ...
        header("Location: photo_documentation.php");
        exit;
    }

    if ($_FILES["photo_documentationDocument"]["size"] > 10000000) {
        error_log("File size exceeds limit: " . $_FILES["photo_documentationDocument"]["size"]);
    ...
    if (move_uploaded_file($_FILES["photo_documentationDocument"]["tmp_name"], $target_file)) {
        ...
        try {
            ...
            $sql = $existing_document ? 
                ...
                "INSERT INTO endorsement_documents 
                 ...
                 VALUES (?, ?, 'photo_documentation', ?, NOW(), ?)";
        ...
        error_log("File move failed. Error: " . $_FILES["photo_documentationDocument"]["error"]);
        $_SESSION['status'] = "Upload failed. Error: " . $_FILES["photo_documentationDocument"]["error"];
        $_SESSION['status-code'] = "error";
    }
...
if ($existing_document) {
    $status_msg = [
        ...
        'pending' => "Your Photo Documentation has been submitted and Under review."
    ];
                    ...
                    <div class="content">
                        ...
                        <div class="action-buttons">
                            <form id="uploadForm" action="" method="POST" enctype="multipart/form-data">
                                <input type="file" id="fileInput" name="photo_documentationDocument" accept=".pdf,.doc,.docx" class="hidden">
