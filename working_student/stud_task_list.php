...
<head>
    ...
    <title>OJT Web Portal: Tasks List</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
...
if (isset($_SESSION['auth_user']['student_id'])) {
    ...
    $stmt = $conn->prepare("SELECT *, stud_task_list.id AS taskID FROM stud_task_list LEFT JOIN students_data
...
?>
        <tr>
            ...
            <td><a href="stud_confirm_task.php?task_id=<?= $result['taskID'] ?>" class="btn btn-primary"> DONE </a></td>
        </tr>
<?php
    }
}
