...
if (isset($_POST['submit'])) {
    ...
    error_log("Temporary file path: " . $_FILES["insuranceDocument"]["tmp_name"]);
    error_log("Upload error code: " . $_FILES["insuranceDocument"]["error"]);
    ...
    if ($_FILES["insuranceDocument"]["size"] > 10000000) {
        error_log("File size exceeds limit: " . $_FILES["insuranceDocument"]["size"]);
    ...
    if (move_uploaded_file($_FILES["insuranceDocument"]["tmp_name"], $target_file)) {
        ...
        error_log("File move failed. Error: " . $_FILES["insuranceDocument"]["error"]);
...
<head>
    ...
    <title>OJT Web Portal: Student Insurance</title>
    ...
    <div class="content-wrap" style="height: 80%; width: 100%; margin: 0 auto; position: relative;">
        <div style="background-color: white; margin-top: 6rem; margin-left: 16rem; padding: 2rem;">
            <div>
                ...
                <div>
                    <h1 class="moa-title">Insurance Document Template</h1>
                </div>
                    ...
                    <div class="content">
                        <div class="document-area" id="documentArea">
                            <?php if ($existing_document): ?>
                                ...
                                ?>
                                    <img id="documentImage" src="<?php echo $existing_document['uploaded_path'] . $cache_buster; ?>" alt="Insurance Image">
