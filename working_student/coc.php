...
if ($existing_document) {
    $status_msg = [
        'accepted' => "Your Certificate of Completoin has been approved.",
        'denied' => "Your Certificate of Completoin was denied. Please review the feedback and submit a revised version.",
        'pending' => "Your Certificate of Completoin has been submitted and Under review."
    ];
