...
if (isset($_POST['submit'])) {
    ...
    error_log("Temporary file path: " . $_FILES["internshipAgreementDocument"]["tmp_name"]);
    error_log("Upload error code: " . $_FILES["internshipAgreementDocument"]["error"]);
    ...
    if ($_FILES["internshipAgreementDocument"]["size"] > 10000000) {
        error_log("File size exceeds limit: " . $_FILES["internshipAgreementDocument"]["size"]);
    ...
    if (move_uploaded_file($_FILES["internshipAgreementDocument"]["tmp_name"], $target_file)) {
        ...
        error_log("File move failed. Error: " . $_FILES["internshipAgreementDocument"]["error"]);
    ...
    <div class="content-wrap" style="height: 80%; width: 100%; margin: 0 auto; position: relative;">
        <div style="background-color: white; margin-top: 6rem; margin-left: 16rem; padding: 2rem;">
            <div>
                ...
                <div>
                    <h1 class="moa-title">Internship Agreement Document Template</h1>
                </div>
