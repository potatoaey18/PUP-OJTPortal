...
if (isset($_POST['submit'])) {
    ...
    error_log("Temporary file path: " . $_FILES["medicalDocument"]["tmp_name"]);
    error_log("Upload error code: " . $_FILES["medicalDocument"]["error"]);
    ...
    if ($_FILES["medicalDocument"]["size"] > 10000000) {
        error_log("File size exceeds limit: " . $_FILES["medicalDocument"]["size"]);
    ...
    if (move_uploaded_file($_FILES["medicalDocument"]["tmp_name"], $target_file)) {
        ...
        error_log("File move failed. Error: " . $_FILES["medicalDocument"]["error"]);
...
try {
    $stmt = $conn->prepare("SELECT *, DATE_FORMAT(upload_date, '%M %d, %Y %H:%i') AS formatted_date 
                           ...
                           WHERE student_id = ? AND document_type = 'medical'");
        ...
        <div style="background-color: white; margin-top: 6rem; margin-left: 16rem; padding: 2rem;">
            <div>
                ...
                <div class="template-box">
                    <a href="templates/endorsement/medical_template.docx" download="medical_template.docx" class="btn1-download-template"><img src="images/doc.png" alt="" class="doc-icon"><u>Medical_Template.docx</u></a>
                    ...
                    <div class="content">
                        <div class="document-area" id="documentArea">
                            <?php if ($existing_document && !empty($existing_document['uploaded_path'])): ?>
                                ...
                                ?>
                                    <img id="documentImage" src="<?php echo $existing_document['uploaded_path'] . $cache_buster; ?>" alt="Medical Certificate Image">
