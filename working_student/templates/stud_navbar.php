        ...
        <div class="sidenav">
            ...
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-content" <?php echo (in_array($current_page, ['appointment_meetings.php', 'pre-internship_documentations.php', 'documentation.php', 'certification.php', 'portfolio.php'])) ? 'style="display: block;"' : ''; ?>>
                        <a href="appointment_meetings.php" class="<?php echo ($current_page == 'appointment_meetings.php') ? 'active' : ''; ?>"><img src="images/appointment.png"> Appointment Meetings </a>
                        <a href="pre-internship_documentations.php" class="<?php echo ($current_page == 'pre-internship_documentations.php') ? 'active' : ''; ?>"><img src="images/endorsement.png"> Pre-internship Documentations </a>
