...
session_start();
error_log("Session student_ID: " . ($_SESSION['auth_user']['student_id'] ?? 'Not set'));
...
<body>
                    ...
                    <table class="company-table">
                        ...
                        <tbody>
                            ...
                            foreach ($companies as $company) {
                                echo '<tr>';
                                echo '<td><button class="view-profile-btn" data-supervisor-id="' . htmlspecialchars($company['supervisorID']) . '">View Profile</button></ risc>';
    ...
    <script>
        $(document).ready(function() {
            ...
            // Pass student_ID from PHP session to JavaScript
            var studentId = '<?php echo htmlspecialchars($_SESSION['auth_user']['student_id'] ?? ''); ?>';
