...
<script>
  function loadConversation(user_uniqueId_receiver) {
    ...
    window.location.href = 'chat_coordinator.php?userUNIQUEid_receiver=' + user_uniqueId_receiver;
  }
  ...
  function loadSelectedUserConversation() {
    ...
    if (user_uniqueId_receiver) {
      ...
      $.ajax({
        url: 'chat_coordinator_messageLIVECHAT.php', // Replace with the actual URL to load conversation data
        method: 'POST',
        data: {
