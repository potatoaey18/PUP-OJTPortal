...
<body>
    ...
    <header class="header">
        <a href="../pending/login.php" class="back-button">
    ...
    <section>
        <div>
            <div class="u-form u-form-1" style="top: 200px;">
                <form action="../php/stud_registerCode.php" method="POST" enctype="multipart/form-data">
                    <div class="form-grid">
                        <div>
                            ...
                            <input type="text" placeholder="Enter SIS No. (YYYY-NNNNN)" id="text-sis-no" name="student_id" required="true">
                        </div>
                        <div>
                        ...
                        <div>
                            <label for="select-department">Department <span class="required">*</span></label>
                            <select id="select-department" name="stud_dept" required="true">
                                <option value="">Select Department</option>
                                <option value="ITECH">ITECH</option>
                            </select>
                        </div>
                        <div>
                            <label for="text-address">Complete Address <span class="required">*</span></label>
                            <input type="text" placeholder="Enter Address" id="text-address" name="complete_address" required="true">
                        </div>
                        <div>
                            <label for="select-gender">Gender <span class="required">*</span></label>
                            <select id="select-gender" name="stud_gender" required="true">
                        ...
                        <div>
                            <label for="text-phone">Phone Number <span class="required">*</span></label>
                            <input type="text" placeholder="Enter Phone Number" id="text-phone" name="phone_number" required="true">
                        </div>
                        <div>
                            <label for="text-email">Email <span class="required">*</span></label>
                            <input type="email" placeholder="Enter Email" id="text-email" name="stud_email" required="true">
                        </div>
                        <div>
                            <label for="text-guardian-name">Guardian's Name <span class="required">*</span></label>
                            <input type="text" placeholder="Enter Guardian's Name" id="text-guardian-name" name="guardians_name" required="true">
                        </div>

                        <div>
                            <label for="text-guardian-phone">Guardian's Phone Number <span class="required">*</span></label>
                            <input type="text" placeholder="Enter Guardian's Phone" id="text-guardian-phone" name="guardians_cpNumber" required="true">
                        </div>
                        <div>
                            <label for="file-sis-document">Attach SIS Document (PDF) <span class="required">*</span></label>
                            <input type="file" accept="application/pdf" id="file-sis-document" name="sis_document" required="true">
                        </div>
                    </div>
