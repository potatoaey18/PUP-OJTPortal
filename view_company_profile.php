...
// Retrieve supervisor ID from URL
$supervisorId = isset($_GET['supervisor']) ? (int)$_GET['supervisor'] : null;
if (!$supervisorId) {
    echo "<script>alert('No supervisor selected.'); window.location.href='find_hte.php';</script>";
    exit;
}
...
if (!$data) {
    echo "<script>alert('Supervisor not found.'); window.location.href='find_hte.php';</script>";
    exit;
}
?>
