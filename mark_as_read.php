...
$supervisor_id = $_SESSION['auth_user']['userid'];
...
try {
    ...
    // First, verify these messages belong to a conversation with this supervisor
    ...
    $params = array_merge($message_ids, [$supervisor_id]);
