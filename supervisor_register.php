        ...
        <div>
          <div>
            ...
            <form action="../php/supervisor_registerCode.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row-4">
                    <div>
                      <label for="text-63ba">Company Address <span class="required">*</span></label>
                      <input type="text" placeholder="Company Address" id="text-63ba" name="companyADDRESS" required="true">
                    </div>
                    
                    <div>
                      <label for="text-1c0f">Select Image <span class="required">*</span></label>
                      <input type="file" accept="image/*" placeholder="Image File" id="text-df1c" name="supervisor_pic" required="true">
                    </div>
