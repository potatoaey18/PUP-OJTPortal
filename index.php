          ...
          <div class="header">
            ...
            <form action="../php/supervisor_loginCode.php" method="POST">
                <div class="u-form-group u-form-name">
                  <label for="supervisorEMAIL" class="u-label">Username</label><br>
                  <input type="email" placeholder="Enter Username" id="supervisorEMAIL" name="supervisorEmail"  required="">
                </div>
                <div class="u-form-email u-form-group">
                  <label for="pword" class="u-label">Password</label><br>
                  <input type="password" placeholder="Enter Password" id="pword" name="supervisorPword"  required="">
                </div>
                <div class="u-align-center u-form-group u-form-submit">
                <button name="LogIn" class="login-button">Log In</button>
                </div>
                <p><a href="#"  class="forgot-password">Forgot Password?</a></p>
                <p ><a href="supervisor_register.php" class="register-here">Register Here</a></p>
              </form>
              <br>
            </div>
          </div>
