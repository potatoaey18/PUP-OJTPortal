...
<body>
                    ...
                    <div class="contacts-list">
                        ...
                        try {
                            ...
                            foreach ($supervisors as &$supervisor) {
                                $stmt = $conn->prepare("
                                    ...
                                    LIMIT 1
                                ");
                                $stmt->execute([$coordinator_id, $supervisor['id']]);
                        ...
                        if (count($supervisors) > 0) {
                            foreach ($supervisors as $supervisor) {
                                ...
                                echo "<div class='contact-item' data-coordinator-id='{$supervisor['id']}'>";
    ...
    $(document).ready(function() {
        ...
        function loadSupervisorMessages(coordinatorId) {
            if (!coordinatorId) return;
            
            console.log('Loading messages for coordinator ID:', coordinatorId);
            currentStudentId = coordinatorId;
            $('#currentStudentId').val(coordinatorId);
            ...
            $('#chatStudentName').text(coordinatorName || 'Student');
            ...
            $.ajax({
                url: 'get_message_supervisor.php',
                type: 'GET',
                data: { supervisor_id: coordinatorId },
                dataType: 'json',
        ...
        function sendMessage() {
            ...
            console.log('Message to send:', message, ', to coordinator:', currentStudentId);
            ...
            $.ajax({
                url: 'send_message_supervisor.php',
                type: 'POST',
                data: {
    ...
    if (typeof Toastify !== 'undefined') {
        ...
        function selectConversation(coordinatorId, coordinatorName) {
            ...
            $('#chatStudentName').text(coordinatorName);
            ...
            loadSupervisorMessages(coordinatorId);
            updateFileCounts();
        ...
        function initializePusher() {
            ...
            try {
                ...
                console.log('Coordinator ID from session:', '<?php echo $_SESSION['auth_user']['coordinators_id'] ?? 'not set'; ?>');
