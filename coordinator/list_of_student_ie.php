...
<html lang="en">
    ...
    <div class="content-wrap" style="height: 80%; width: 100%; margin: 0 auto;">
        <div style="background-color: white; margin-top: 6rem; margin-left: 16rem; padding: 2rem;">
            ...
            <div class="page-header">
                <div class="page-title"><br><h1 style="font-size: 16px;"><b>Internship Update (Internship Experience)</b></h1><br><br></div>
            </div>
    ...
    <script>
        ...
        window.location.href = "view_student_ie.php?id=" + encodeURIComponent(studID);
    });
    </script>
    </body>
</html>