    ...
    <div>
        <div class="sidenav">
            ...
            <ul>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle"><img src="../student/images/todo.png"> To do</a>
                    <div class="dropdown-content" <?php echo (in_array($current_page, ['partner_companies.php', 'Trainees.php', 'stud_endorsement_validation.php', 'internship_update.php', 'certification.php', 'portfolio.php'])) ? 'style="display: block;"' : ''; ?>>
                        <a href="partner_companies.php" class="<?php echo ($current_page == 'partner_companies.php') ? 'active' : ''; ?>"><img src="../student/images/search.png"> Appointment Meetings (ND)</a>
                        <a href="Trainees.php" class="<?php echo ($current_page == 'Trainees.php') ? 'active' : ''; ?>"><img src="../student/images/Trainees.png"> Trainees</a>
                        <a href="stud_endorsement_validation.php" class="<?php echo ($current_page == 'stud_endorsement_validation.php') ? 'active' : ''; ?>"><img src="../student/images/internship_docs.png"> Endorsement Papers</a>
                        <a href="internship_update.php" class="<?php echo ($current_page == 'internship_update.php') ? 'active' : ''; ?>"><img src="../student/images/evaluation.png"> Internship Update</a>
                        <a href="certification.php" class="<?php echo ($current_page == 'certification.php') ? 'active' : ''; ?>"><img src="../student/images/certificate.png"> Certification of Completion</a>
                        <a href="portfolio.php" class="<?php echo ($current_page == 'portfolio.php') ? 'active' : ''; ?>"><img src="../student/images/portfolio.png"> Portfolio</a>
                    </div>
                </li>
            </ul>
        </div>
