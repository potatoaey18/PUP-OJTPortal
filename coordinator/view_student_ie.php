    ...
    <body>
            ...
            <div style="background-color: white; margin-top: 6rem; margin-left: 16rem; padding: 2rem;">
                ...
                <div class="content-holder">
                    <div class="file-overview-holder">
                        <fieldset>
                            <legend>Internship Experience</legend>
                            <div class="overview-cont">
                                <?php if ($ie): ?>
                                    <div class="moa-preview" id="iePreview">
                                        <?php
                                        $file_ext = strtolower(pathinfo($ie['uploaded_path'], PATHINFO_EXTENSION));
                                        if ($file_ext === 'pdf'): ?>
                                            <iframe src="<?php echo $ie['uploaded_path'] . '?t=' . time(); ?>" frameborder="0"></iframe>
                                        <?php elseif (in_array($file_ext, ['jpg', 'jpeg', 'png', 'gif'])): ?>
                                            <img src="<?php echo $ie['uploaded_path']; ?>" alt="MOA Image">
                                        <?php else: ?>
                    ...
                    <div class="info-function-cont">
                            ...
                            <div class="moa-overview">
                                <?php if ($ie): ?>
                                    <div class="data-row">
                                        ...
                                        <div class="student-data">: <?php echo htmlspecialchars($ie['document_name']); ?></div>
                                    </div>
                                    <div class="data-row">
                                        <div class="label"><p><b>Status</b></p></div>
                                        <div class="student-data">: <?php echo htmlspecialchars(ucfirst($ie['status'])); ?></div>
                                    </div>
                                <?php else: ?>
                                    <div class="data-row">
                        ...
                        <div class="button-function">
                            <button class="btn-style" onclick="viewMoa()" <?php echo $ie ? '' : 'disabled'; ?>>
                                <i class="fa-regular fa-eye"></i> View
                            </button>
                            <button class="btn-style" onclick="updateStatus(<?php echo $ie['document_id'] ?? 'null'; ?>, 'accepted')" <?php echo $ie && $ie['status'] !== 'accepted' ? '' : 'disabled'; ?>>
                                <i class="fa-solid fa-circle-check"></i> Approve
                            </button>
                            <button class="btn-style" onclick="toggleReject()" <?php echo $ie && $ie['status'] !== 'denied' ? '' : 'disabled'; ?>>
        ...
        <script>
            ...
            function updateStatus(documentId, status, remarks = null) {
                if (documentId === null) {
                    swal("Error", "No Internship Experience document available to update.", "error");
                    return;
                }
                swal({
                    title: `Are you sure?`,
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                remarksBtn.addEventListener('click', function() {
                    const documentId = <?php echo $ie['document_id'] ?? 'null'; ?>;
